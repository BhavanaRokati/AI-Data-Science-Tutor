...
Original file is located at
    https://colab.research.google.com/drive/1ktp2iIXXkMdTZPphoi9BVZBZXs3iWgkW
"""
...
ai_model = ChatGoogleGenerativeAI(model="gemini-1.5-pro", temperature=0.7, google_api_key="YOUR API KEY")
...
# Streamlit App
def main():
    st.image(r"E:\Innomatics Internship\download.jpeg", width=400)
